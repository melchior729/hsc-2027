...
| [events.md](events.md) | Main 5 events: timing, vibe, run of show |
| [ratification.md](ratification.md) | USC ratification goal, Oct 15 deadline, next steps |
| [responsibilities.md](responsibilities.md) | First takeaways per person (follow up after meetings) |
| [content.md](content.md) | Comms vs Production Team Instagram tracks |
| [budget.md](budget.md) | $650 ceiling + reimbursement after ratification |
| [space.md](space.md) | Multifaith Room / Mandir + dedicated Hindu room goal |
