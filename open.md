...
- [ ] Complete all planning files (structure, calendars, events, ratification, content, budget, space, connections, ideas, responsibilities)
- [x] Events draft complete → [events.md](events.md) (needs confirmation from Ananya, Ishani, and Shivan)
...
- [ ] O-Week stations: plan around [academic-calendar.md](academic-calendar.md) and **$650** → [budget.md](budget.md) / [events.md](events.md)
