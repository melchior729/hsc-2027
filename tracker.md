...
See also: [responsibilities.md](responsibilities.md) · [README.md](README.md)
...
- [ ] Lock exec socials with Anishka (`@bringup[Ananya]`: maybe 1 per month) → [responsibilities.md](responsibilities.md)
...
- [ ] Confirm all five main events with Ishani and Shivan → [events.md](events.md) / [responsibilities.md](responsibilities.md)
- [ ] Decide OWeek table / booth + station format → [events.md](events.md)
...
- [ ] Coordinate director recruitment (Anishka; each VP fills their own slots after the form is live) → [responsibilities.md](responsibilities.md)
- [ ] Lock exec socials with Co-presidents (Anishka + Abhay / Ananya) → [responsibilities.md](responsibilities.md)
...
- [ ] Decide event photography gear and how coverage gets assigned per event → [content.md](content.md)
...
- [ ] Decide whether to pursue Mandir donation box + QR → [ideas.md](ideas.md) (USC donation-platform rules live in checklist item 7 → [ratification.md](ratification.md))
- [ ] Decide whether to pursue club merch / print-on-demand store → [ideas.md](ideas.md) (USC merch rules live in checklist item 9 → [ratification.md](ratification.md))
