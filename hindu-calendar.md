...
- **Post:** Instagram post on the day (baseline for everything on this list)
- **Puja / aarti:** for larger days, hold a puja or aarti (likely Multifaith Room / Mandir)
...
Handling column is intentionally mostly blank for non-main days. We will fill it in as we build the schedule.

See also: [events.md](events.md) · [academic-calendar.md](academic-calendar.md) · [content.md](content.md)

## Summer / Pre-Term 2026

| Date | Event | Academic context | Handling |
| --- | --- | --- | --- |
| Thu, Jul 16 | Rath Yatra | Summer Break | TBD |
...
| Date | Event | Academic context | Handling |
| --- | --- | --- | --- |
| Fri, Sep 4 | Krishna Janmashtami | Before OWeek starts (Sep 7) | TBD |
| Mon, Sep 14 | Ganesh Chaturthi | First week of classes | **Celebrate: main event #1** (aarti + intro social) |
| Fri, Sep 25 | Anant Chaturdashi (Ganesh Visarjan) | Mid-Term | TBD |
| Sep 26 - Oct 10 | Pitru Paksha & Mahalaya | Leading up to Fall Reading Week | TBD |
...
| **Sun, Nov 8** | **Diwali (Lakshmi Puja)** | Mid-Term | **Celebrate: main event #2** |
...
| Date | Event | Academic context | Handling |
| --- | --- | --- | --- |
| Wed, Jan 13 | Lohri | Second week of classes | TBD |
| Jan 14 - 15 | Makar Sankranti / Pongal | Second week of classes | **Celebrate: main event #3** (welcome-back social) |
